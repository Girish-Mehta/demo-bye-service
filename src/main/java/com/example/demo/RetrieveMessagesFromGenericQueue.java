...
public class RetrieveMessagesFromGenericQueue {
	//to show the logs
    private static final Logger log = LoggerFactory.getLogger(DemoByeServiceApplication.class);
   
    //listing to generic queue
    @RabbitListener(queues = DemoByeServiceApplication.QUEUE_GENERIC_NAME)
